...
public class AddressUtils {
	...
	public static void main(String[] args) throws InterruptedException {
		AddressUtils.getResult("http://ip.taobao.com/service/getIpInfo.php", "ip=123.123.12.1", "utf-8");
		Thread.sleep(2000);
	...
	// 测试
	 ...
	 String country =
	 JSONObject.fromObject(json.get("data")).get("country").toString();
	 String region =
	 ...
	 String isp =
	 JSONObject.fromObject(json.get("data")).get("isp").toString();
	 String area =
